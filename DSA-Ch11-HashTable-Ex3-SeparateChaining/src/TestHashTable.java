...
public class TestHashTable {
	...
	public static void main(String[] args) {
		...
		//delete
		System.out.println("delete 154: " + hs.delete(154) );
		System.out.println("delete 240: " + hs.delete(240) );
		System.out.println("delete 350: " + hs.delete(350) );
		System.out.println(hs);
		System.out.println();
		
		//another insert
		System.out.println("Inserting Sara... ");
		hs.insert(new Employee("Sara", 330));
		System.out.println(hs);
		System.out.println();
